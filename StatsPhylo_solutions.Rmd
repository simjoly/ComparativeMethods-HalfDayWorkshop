...
All the data of the workshop are deposited in a github repository. The easiest way to access them is to go to the workshop directory and clone it on your computer. [Workshop repository](http://www.github.com/simjoly/ComparativeMethods-HalfDayWorkshop).

Once you have cloned the repository, you need to open R (R studio) and set the working directory to the repository folder ("/ComparativeMethods-HalfDayWorkshop"). In RStudio, to change the working directory, you choose `>Session>Set Working directory>Choose Directory`.You are now ready to do the exercises.
